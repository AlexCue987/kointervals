...
class SetWithNoGreaterThanTest {
    val originalRange = noGreaterThan(1)
    ...
    fun setsNoGreaterThanWithLowerValue() {
        ...
        val expected = rangeMapOf(
                ...
                0 openClosed 1 to originalValue).toList()
        assertEquals(expected, sut.toList())
    }
    ...
    fun setsLessThanWithLowerValue() {
        ...
        val expected = rangeMapOf(
                ...
                0 closedClosed 1 to originalValue).toList()
        assertEquals(expected, sut.toList())
    }
    ...
    fun setsValueInside() {
        ...
        val expected = rangeMapOf(
                ...
                -3 openClosed 1 to originalValue).toList()
        assertEquals(expected, sut.toList())
    }
