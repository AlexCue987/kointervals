...
class SetWithNoLessThanTest {
    val sut = mutableRangeMapOf(noLessThan(1) to "Rainy")

    @Test
    fun setsGreaterThanWithHigherValue() {
        sut[greaterThan(5)] = "Windy"
        val expected = rangeMapOf(
                1 closedClosed 5 to "Rainy",
